...
public class NextTurnWeak extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("NextTurnWeak");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("NextTurnWeak84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("NextTurnWeak32.png"));

    public NextTurnWeak(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new NextTurnWeak(owner, source, amount);
    }
}
