...
public class ChargePotion extends AbstractPotion {


    public static final String POTION_ID = theMarked.DefaultMod.makeID("ChargePotion");
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
            this.addToBot(new ApplyPowerAction(target, AbstractDungeon.player, new ChargePower(target,AbstractDungeon.player,potency),potency));
        }
    }
