...
import theMarked.powers.HeritagePower;

import static theMarked.DefaultMod.makeCardPath;

public class Heritage extends AbstractDynamicCard {
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new HeritagePower(p,p,magicNumber),magicNumber));
    }
