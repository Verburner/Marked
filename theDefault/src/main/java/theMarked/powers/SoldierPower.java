...
public class SoldierPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("SoldierPower");
    ...
    public SoldierPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card.type == AbstractCard.CardType.ATTACK && !(card instanceof AlyssasBlade)) {
            this.flash();
    ...
    public AbstractPower makeCopy() {
        return new SoldierPower(owner, source, amount);
    }
}
